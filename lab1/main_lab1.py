...
def zadatak7():
    ...
    #
    # acc_val, pr_val, m_val = data.eval_perf_multi(labels_val, predicts_val)
    ...
    #
    # acc_test, pr_test, m_test = data.eval_perf_multi(labels_test, predicts_test)
    ...
    # acc, pr, m = data.eval_perf_multi(np.argmax(mnist.test.labels, axis=1), predicts)
    # print("accuracy={}, precision={}, recall={}".format(acc, pr[0][0], pr[0][1]))
    #
    # data.plot_data(mnist.train.images, np.argmax(mnist.train.labels, axis=1), predicts, ksvm1)
    #
    ...
    #
    # plt.figure(4)
    # data.plot_weights(ksvm2.get_wights()[0])
